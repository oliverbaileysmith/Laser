	...
	unsigned int transformIndex)
{
	...
	ProcessAssimpNode(assimpScene->mRootNode, assimpScene, meshes,
		materialIndex, transformIndex, vertexOffset);
...
void ModelLoader::ProcessAssimpNode(aiNode *assimpNode,
	const aiScene *assimpScene, std::vector<TriangleMesh> &meshes,
...
TriangleMesh ModelLoader::ProcessAssimpMesh(aiMesh *assimpMesh,
