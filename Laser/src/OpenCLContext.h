...
public:
	...
	bool AddBuffer(const std::string& bufferKey, cl_mem_flags clMemFlag, size_t size);
	...
	bool QueueWrite(const std::string& bufferKey, cl_bool blocking, size_t offset, size_t size, const void* data);
	bool QueueRead(const std::string& bufferKey, cl_bool blocking, size_t offset, size_t size, void* data);
	bool QueueKernel(const cl::NDRange& offset, const cl::NDRange& global, const cl::NDRange& local = cl::NullRange);
