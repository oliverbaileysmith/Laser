...
Camera::Camera(cl_float3 position, cl_float3 target, cl_float verticalFOV, cl_float aspectRatio)
{
    ...
    glm::vec3 horizontal = viewportWidth * u;
    glm::vec3 vertical = viewportHeight * v;
    glm::vec3 upperLeftCorner = glmPosition - horizontal / 2.0f + vertical / 2.0f - w;
    m_Props.UpperLeftCorner = {upperLeftCorner.x, upperLeftCorner.y, upperLeftCorner.z};
